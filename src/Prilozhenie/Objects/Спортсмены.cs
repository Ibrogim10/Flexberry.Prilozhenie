    ...
    public class Спортсмены : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СпортсменыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпортсменыE", typeof(IIS.Prilozhenie.Спортсмены));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СпортсменыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СпортсменыL", typeof(IIS.Prilozhenie.Спортсмены));
                }
            }
        }
    }
