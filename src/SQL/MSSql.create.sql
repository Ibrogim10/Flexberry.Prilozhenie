...
CREATE TABLE [ТЧСоставаСпорт] (
	 ...
	 [Спортсмены] UNIQUEIDENTIFIER  NOT NULL,

	 [СоставКоманды] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [ТЧГрафика] (
	 ...
	 [ДатаПроведения] DATETIME  NULL,

	 [МестоПроведения] VARCHAR(255)  NULL,

	 [ГруппыВозраст] UNIQUEIDENTIFIER  NOT NULL,

	 [ГрафикМатчей] UNIQUEIDENTIFIER  NOT NULL,
