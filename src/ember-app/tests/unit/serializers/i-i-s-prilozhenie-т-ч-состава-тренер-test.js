...
moduleForModel('i-i-s-prilozhenie-т-ч-состава-тренер', 'Unit | Serializer | i-i-s-prilozhenie-т-ч-состава-тренер', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-т-ч-состава-тренер',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
